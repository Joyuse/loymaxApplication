...
interface RegistrationService {
    ...
    fun registrationBatchRegistrationConfirm(@Query("description") description: kotlin.String, @Query("file") file: java.io.File, @Query("setRandomPasswords") setRandomPasswords: kotlin.Boolean? = null): ResultModelOfInt32
    ...
    fun registrationGetConfirmRegistrationBatch(@Query("from") from: kotlin.Int? = null, @Query("count") count: kotlin.Int? = null, @Query("batchUploadFilterModel.state") batchUploadFilterModelState: BatchState? = null, @Query("batchUploadFilterModel.includeDeleted") batchUploadFilterModelIncludeDeleted: kotlin.Boolean? = null, @Query("batchUploadFilterModel.fromDate") batchUploadFilterModelFromDate: kotlin.String? = null, @Query("batchUploadFilterModel.toDate") batchUploadFilterModelToDate: kotlin.String? = null, @Query("batchUploadFilterModel.authorId") batchUploadFilterModelAuthorId: kotlin.Int? = null): ResultModelOfPagedViewModelOfBatchUploadModel
    ...
    fun registrationPostBeginRegistration(@Query("login") login: kotlin.String? = null, @Query("password") password: kotlin.String? = null, @Query("withoutCall") withoutCall: kotlin.Boolean? = null, @Query("cvcCode") cvcCode: kotlin.String? = null): ResultModelOfRegistrationResult
    ...
    fun registrationPostTryFinishRegistration(): ResultModelOfFinishRegistrationResultModel
    ...
    suspend fun registrationRegisterAnonymous(
        @Body registerAnonymousRequest: RegisterAnonymousRequest
       ): ResultModelOfAnonymousRegistrationResult

//    @POST("v1.2/Registration/RegisterAnonym")
//    fun registrationRegisterAnonymous(
//        @Query("userIdentifier") userIdentifier: java.util.UUID? = null, @Query("password") password: kotlin.String? = null): Call<ResultModelOfAnonymousRegistrationResult>
    ...
    fun registrationTryFinishRegistration(@Query("personId") personId: kotlin.Int? = null): ResultModelOfFinishRegistrationResult
