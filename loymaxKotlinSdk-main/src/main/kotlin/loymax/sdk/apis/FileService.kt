...
interface FileService {
     ...
     */
    @GET("v1.2/files/{id}")
    suspend fun fileGet(@Path("id") id: kotlin.Int): ResultModelOfFileEdit
     ...
     * @return [Call]<[ResultModelOfFileEdit]>
     */
//    @GET("v1/files/guid/{guid}")
//    suspend fun fileGetFileByGuid(@Path("guid") guid: kotlin.String): ResultModelOfFileEdit
