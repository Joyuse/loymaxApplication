...
interface FileStorageService {
     ...
     */
    @GET("v1.2/Files/{uid}")
    suspend fun fileStorageGet(@Path("uid") uid: kotlin.String, @Query("taskId") taskId: kotlin.Int? = null, @Query("isDownload") isDownload: kotlin.Boolean? = null): Any

    fun getFilesUrl(uidFile: String): String {
        return ApiClient.defaultBasePath + "v1/Files/" + uidFile
    }
}
