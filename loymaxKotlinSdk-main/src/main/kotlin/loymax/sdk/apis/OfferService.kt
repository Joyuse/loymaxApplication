...
interface OfferService {
    ...
    fun offerGetDetail(
        @Path("offerId") offerId: kotlin.Int,
        @Path("detailId") detailId: kotlin.String
    ): Call<ResultModelOfDetailItem>
    ...
    fun offerGetDetailMerchants(
        @Path("offerId") offerId: kotlin.Int,
        @Path("detailId") detailId: kotlin.String
    ): Call<ResultModelOfListOfMerchantInfoModel>
    ...
    fun offerGetDetails(
        ...
        @Query("from") from: kotlin.Int? = null,
        @Query("count") count: kotlin.Int? = null
    ): Call<ResultModelOfPagedViewModelOfDetailItem>
     ...
     */
    @GET("v1.2/Offer/{id}")
    suspend fun offerGetOffer(@Path("id") id: kotlin.Int): ResultModelOfOfferModel
    ...
    @GET("v1.2/Offer")
    fun offerGetOffers(
        @Query("filter.merchantId") filterMerchantId: kotlin.Int? = null,
        @Query("filter.offerState") filterOfferState: CommunicationOfferState? = null,
        @Query("filter.from") filterFrom: kotlin.Int? = null,
        @Query("filter.count") filterCount: kotlin.Int? = null,
        @Query("filter.type") filterType: CommunicationOfferType? = null,
        @Query("filter.categoryFilterType") filterCategoryFilterType: OfferCategoryFilterType? = null,
        @Query("filter.categoryLogicalNames") filterCategoryLogicalNames: kotlin.collections.MutableList<kotlin.String>? = null
    ): Call<ResultModelOfPagedViewModelOfOfferModel>


    @GET("v1.2/Offer")
    suspend fun getListOffers(
        @Query("filter.merchantId") filterMerchantId: kotlin.Int? = null,
        @Query("filter.offerState") filterOfferState: CommunicationOfferState? = null,
        @Query("filter.from") filterFrom: kotlin.Int? = null,
        @Query("filter.count") filterCount: kotlin.Int? = null,
