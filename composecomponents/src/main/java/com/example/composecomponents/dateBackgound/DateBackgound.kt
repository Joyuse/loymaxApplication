package com.example.composecomponents.dateBackgound
...
fun DateBackground(
    ...
    text: String = stringResource(id = R.string.event_time),
    formatTextIsNeeded: Boolean = true,
) {
    Row(
        ...
        if (dateTo != null && dateFrom != null) {
            ...
            if(formatTextIsNeeded) {
                Text(
                    modifier = textModifier,
                    textAlign = textAlign,
                    text = text.format(dateTo, dateFrom)
                )
            } else {
                Text(
                    modifier = textModifier,
